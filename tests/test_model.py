...
from ptsr.model.common import PreActBasicBlock, \
    PreActBottleneck, MBConvBlock
...
class TestModel(unittest.TestCase):
    ...
    def test_building_blocks(self):
        ...
        for block in [PreActBasicBlock, PreActBottleneck, MBConvBlock]:
